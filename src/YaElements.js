...
export const componentGenerator = (element, name, options) => ({
  ...
  render (h, {data, children}) {
    let {tag, ...otherAttrs} = data.attrs || {}
    tag = tag || options.tagMap[element] || 'div'
    let attrs = {}
    let cls = {}
    let clsDash = {}
    ...
    data.class = {...options.baseClass, ...cls, ...clsDash, ...elementClass, ...data.class}
...
export default function YaElements (options = {}) {
  options = {...defaultYaElementsOptions, ...options}
